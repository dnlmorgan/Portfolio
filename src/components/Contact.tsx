export default function Contact() {
  return (
    <section className="mb-20">
      <div
        className="rounded-2xl bg-white/[0.02] p-6 md:p-10 border border-white/10 text-center relative overflow-hidden"
      >

        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          <p className="section-title mb-4">Next Steps</p>
          <h2 className="section-heading mb-8">Let's build the future.</h2>

          <div className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl rounded-2xl bg-white/[0.02] border border-white/5 p-5 sm:p-6 backdrop-blur-md hover:bg-white/[0.04] transition-colors mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="https://github.com/dnlmorgan/" target="_blank" rel="noreferrer" className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/10">
              GitHub
